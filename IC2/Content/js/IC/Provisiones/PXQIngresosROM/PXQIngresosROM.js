...
Ext.onReady(function () {
    ...
    var panel = Ext.create('Ext.form.Panel', {
        ...
        items: [
            {
                html: "<div style='font-size:25px';>PXQ Ingresos Roaming</div><br/>",
                border: false,
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                columns: [
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'ingresoTraficoUSD', text: "ingresoTraficoUSD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_MOC_IOTFacturado', text: "USD_MOC_IOTFacturado", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_MTC_IOTFacturado', text: "USD_MTC_IOTFacturado", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_SMS_MO_IOTFacturado', text: "USD_SMS_MO_IOTFacturado", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_GPRS_IOTFacturado', text: "USD_GPRS_IOTFacturado", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'PROV_NC_M2M_USD', text: "PROV_NC_M2M_USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'ajustePROV_M2M_USD_MesAnterior', text: "Ajuste PROV M2M USD Mes Anterior", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'PROV_TAR_MesAnteriorUSD', text: "PROV TAR Mes Anterior USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'ajusteRal_VS_DevengoTarifaMesAnterior', text: "Ajuste Real VS Devemgo Tarifa Mes Anterior", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'total_USD_PROV_Tarifa', text: "Total USD PROV Tarifa", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'facturacion_REALTraficoMesAnterior', text: "Facturacion Real Tráfico Mes Anterior", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'ajusteReal_VS_DevengoTraficoMesAnteriorUSD', text: "Ajuste Real VS Devengo Tráfico Mes Anterior USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'ajusteMesesAnterioresUSD', text: "Ajuste Meses Anteriores USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    ,
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'totalNetoUSD', text: "Total Neto USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
