...
Ext.onReady(function () {
    ...
    var panel = Ext.create('Ext.form.Panel', {
        ...
        items: [
            {
                html: "<div style='font-size:25px';>PXQ Costos Roaming</div><br/>",
                border: false,
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                columns: [
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'MIN_MOC_REDONDEADO', text: "MIN_MOC_REDONDEADO", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'MIN_MOC_REAL', text: "MIN_MOC_REAL", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'SDR_MOC', text: "SDR_MOC", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'MIN_MTC_REDONDEADO', text: "MIN_MTC_REDONDEADO", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'MIN_MTC_REAL', text: "MIN_MTC_REAL", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'SDR_MTC', text: "SDR_MTC", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "gridcolumn", align: 'right', sortable: true, dataIndex: 'SMS_MO', text: "SMS_MO", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'SDR_SMS', text: "SDR_SMS", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'GPRS', text: "GPRS", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'SDR_GPRS', text: "SDR_GPRS", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_MOC', text: "USD_MOC", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_MTC', text: "USD_MTC", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_SMS_MO', text: "USD_SMS_MO", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_GPRS', text: "USD_GPRS", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'COSTO_TRAFICO_USD', text: "Costo Trafico USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_MOC_IOTFacturado', text: "USD_MOC_IOT Facturado", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_MTC_IOTFacturado', text: "USD_MTC_IOT Facturado", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_SMS_MO_IOTFacturado', text: "USD_SMS_MO_IOT Facturado", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_GPRS_IOTFacturado', text: "USD_GPRS_IOT Facturado", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_MOC_IOT_REAL', text: "USD_MOC_IOT_REAL", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_MTC_IOT_REAL', text: "USD_MTC_IOT_REAL", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_MOC_IOT_DESC', text: "USD_MOC_IOT_DESC", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_MTC_IOT_DESC', text: "USD_MTC_IOT_DESC", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_SMS_MO_IOT_DESC', text: "USD_SMS_MO_IOT_DESC", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_GPRS_IOT_DESC', text: "USD_GPRS_IOT_DESC", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'USD_SUMA_PROV_TARIFA', text: "USD_SUMA_PROV_TARIFA", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'costosFijosRecurrentes', text: "Costos Fijos Recurrentes", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'PROVRealTarifaMesAnteriorUSD', text: "PROV Real Tarifa Mes Anterior USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'PROVTarMesAnteriorUSD', text: "PROV TAR Mes Anterior USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'ajuste_Real_VS_DevengoTarifaMesAnteriroUSD', text: "Ajuste Real VS Devengo Tarifa Mes Anterir USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'total_USD_PROV_Tarifa', text: "Total_USD_PROV_Tarifa", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'facturacionRealMesAnteriorUSD', text: "Facturación Real Mes Anterior USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'PROVTraficoMesAnteriorUSD', text: "PROV Tráfico Mes Anterior USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'ajusteReal_VS_DevengoTraficoMesAnteriorUSD', text: "Ajuste Real VS Devengo Trafico Mes Anterior USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'ajusteSaldoMesAnterior', text: "Ajuste Saldo Mes Anterior", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'totalUSDTrafico', text: "Total USD Tráfico", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'ajusteTraficoMesAnterior', text: "Ajuste Tráfico Mes Anterior", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'ajusteTarifaMesAnterior', text: "Ajuste Tarifa Mes Anterior", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'ajusteCostosRecurresntesMesesAnteriores', text: "Ajuste Costos Recurresntes Meses Anteriores", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'complementoTarifaMesAnterior', text: "Complemento Tarifa Mes Anterior", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'ajisteMesesAnterioresUSD', text: "Ajuste Meses Anteriores USD", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                    ...
                                    {
                                        xtype: "numbercolumn", align: 'right', format: '0,000.000000', sortable: true, dataIndex: 'totalNeto', text: "Total Neto", width: "14%",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
