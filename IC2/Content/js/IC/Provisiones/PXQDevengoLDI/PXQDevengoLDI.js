...
Ext.onReady(function () {
    ...
    Ext.define('model_BuscarPXQDevengoLDI',
        {
            extend: 'Ext.data.Model',
            fields: [
    ...
    var storeLlenaPeriodo = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'PXQDevengoLDI/LlenaPeriodo?lineaNegocio=' + 2,
            reader: {
                type: 'json',
                root: 'results',
    ...
    var store_BuscarPXQDevengoLDIDocumento = Ext.create('Ext.data.Store', {
        model: 'model_BuscarPXQDevengoLDI',
        storeId: 'idstore_buscarPXQDevengoLDIDocumento',
        groupField: 'CuentaPiv',
        pageSize: 20,
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'PXQDevengoLDI/LlenaGridDocumento',
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var store_BuscarPXQDevengoLDILocal = Ext.create('Ext.data.Store', {
        model: 'model_BuscarPXQDevengoLDI',
        storeId: 'idstore_buscarPXQDevengoLDI',
        groupField: 'CuentaPiv',
        pageSize: 20,
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'PXQDevengoLDI/LlenaGridLocal',
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var paginadorDocumento = new Ext.PagingToolbar({
        id: 'paginadorDoc',
        store: store_BuscarPXQDevengoLDIDocumento,
        displayInfo: true,
        ...
        items: [
            {
                ...
                listeners:
                {
                    change: function (field, newValue, oldValue, eOpts) {
                        ...
                        store_BuscarPXQDevengoLDIDocumento.pageSize = cuenta;
                        store_BuscarPXQDevengoLDIDocumento.load();
                    }
    ...
    var paginadorLocal = new Ext.PagingToolbar({
        id: 'paginadorLoc',
        store: store_BuscarPXQDevengoLDILocal,
        displayInfo: true,
        displayMsg: 'Devengo {0} - {1} of {2}',
        afterPageText: "Siguiente",
        beforePageText: "Anterior",
        ...
        items: [
            {
                ...
                listeners:
                {
                    change: function (field, newValue, oldValue, eOpts) {
                        var cuenta = field.rawValue;
                        store_BuscarPXQDevengoLDILocal.pageSize = cuenta;
                        store_BuscarPXQDevengoLDILocal.load();
                    }
    ...
    var panel = Ext.create('Ext.form.Panel', {
        ...
        items: [
            {
                html: "<div style='font-size:25px';>Devengo Ingresos</div><br/>",
                border: false,
                bodyStyle: { "background-color": "#E6E6E6" },
                width: '50%',
            },
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            //Moneda Documento
                            var storeD = Ext.StoreManager.lookup('idstore_buscarPXQDevengoLDIDocumento');
                            ...
                            //Moneda local
                            var storeL = Ext.StoreManager.lookup('idstore_buscarPXQDevengoLDI');
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            Ext.Ajax.request({
                                timeout: 3600000,
                                url: '../' + VIRTUAL_DIRECTORY + 'PXQDevengoLDI/ExportarReporte',
                                params: {
                                    Periodo: periodo
                                },
                                ...
                                columns: [
                                    {
                                        ...
                                        items:
                                        {
                                            ...
                                            {
                                                keyup: function () {
                                                    store_BuscarPXQDevengoLDIDocumento.clearFilter();
                                                    var cadena = this.value;
                                                    if (this.value && cadena.length > 1) {
                                                        store_BuscarPXQDevengoLDIDocumento.load({ params: { start: 0, limit: 100000 } });
                                                        store_BuscarPXQDevengoLDIDocumento.filter({
                                                            property: 'Cuenta',
                                                            value: this.value,
                                                            anyMatch: true,
                                                            caseSensitive: false
                                    ...
                                    {
                                        xtype: "gridcolumn", sortable: true, dataIndex: 'Operador', text: "Operador", width: "8%",
                                        renderer: function (v, cellValues, rec) {
                                ...
                                columns: [
                                    {
                                        ...
                                        items:
                                        {
                                            ...
                                            {
                                                keyup: function () {
                                                    store_BuscarPXQDevengoLDILocal.clearFilter();
                                                    var cadena = this.value;
                                                    if (this.value && cadena.length > 1) {
                                                        store_BuscarPXQDevengoLDILocal.load({ params: { start: 0, limit: 100000 } });
                                                        store_BuscarPXQDevengoLDILocal.filter({
                                                            property: 'Cuenta',
                                                            value: this.value,
                                                            anyMatch: true,
                                                            caseSensitive: false
