/* Nombre: ReportesDevengoController.js  
...
Ext.onReady(function () {
    ...
    var paginadorDocumento = new Ext.PagingToolbar({
        id: 'paginadorDoc',
        store: store_BuscarReportesDevengoDocumento,
        displayInfo: true,
        ...
        items: [
            {
                ...
                listeners:
                {
                    change: function (field, newValue, oldValue, eOpts) {
                        ...
                        store_BuscarReportesDevengoDocumento.pageSize = cuenta;
                        store_BuscarReportesDevengoDocumento.load();
                    }
    ...
    var paginadorLocal = new Ext.PagingToolbar({
        id: 'paginadorLoc',
        store: store_BuscarReportesDevengoLocal,
        displayInfo: true,
        displayMsg: 'Devengo {0} - {1} of {2}',
        afterPageText: "Siguiente",
        beforePageText: "Anterior",
        ...
        items: [
            {
                ...
                listeners:
                {
                    change: function (field, newValue, oldValue, eOpts) {
                        var cuenta = field.rawValue;
                        store_BuscarReportesDevengoLocal.pageSize = cuenta;
                        store_BuscarReportesDevengoLocal.load();
                    }
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            var storeD = Ext.StoreManager.lookup('idstore_buscarReportesDevengoDocumento');
                            ...
                            //Moneda local
                            var storeL = Ext.StoreManager.lookup('idstore_buscarReportesDevengo');
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            Ext.Ajax.request({
                                timeout: 3600000,
                                url: '../' + VIRTUAL_DIRECTORY + 'ReportesDevengo/ExportarReporte',
                                params: {
                                    Periodo: periodo
                                },
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            {
                                xtype: 'gridpanel',
                                id: 'grp_ReportesDevengoDocumento',
                                flex: 1,
                                store: store_BuscarReportesDevengoDocumento,
                                width: '100%',
                                height: 250,
                                ...
                                columns: [
                                    {
                                        ...
                                        items:
                                        {
                                            ...
                                            {
                                                keyup: function () {
                                                    store_BuscarReportesDevengoDocumento.clearFilter();
                                                    var cadena = this.value;
                                                    if (this.value && cadena.length > 1) {
                                                        store_BuscarReportesDevengoDocumento.load({ params: { start: 0, limit: 100000 } });
                                                        store_BuscarReportesDevengoDocumento.filter({
                                ...
                                columns: [
                                    {
                                        ...
                                        items:
                                        {
                                            ...
                                            {
                                                keyup: function () {
                                                    store_BuscarReportesDevengoLocal.clearFilter();
                                                    var cadena = this.value;
                                                    if (this.value && cadena.length > 1) {
                                                        store_BuscarReportesDevengoLocal.load({ params: { start: 0, limit: 100000 } });
                                                        store_BuscarReportesDevengoLocal.filter({
                                                            property: 'CuentaResultados',
                                                            value: this.value,
                                                            anyMatch: true,
                                                            caseSensitive: false
