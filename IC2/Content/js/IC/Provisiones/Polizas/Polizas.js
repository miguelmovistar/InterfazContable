...
Ext.onReady(function () {
    ...
    var panel = Ext.create('Ext.form.Panel', {
        ...
        items: [
            {
                html: "<h3>Archivos S1/S3/SA</h3> </br>",
                width: '50%',
                border: false
            },
            {
                    ...
                    listeners:
                    {
                        selectionchange: function (selected, eOpts) {
                            ...
                            if (eOpts.length >= 1) {
                                ...
                                storeSeleccionLinea1.getProxy().extraParams.Id = _IdPoliza;
                                ...
                                storeSeleccionLinea2.getProxy().extraParams.Id = _IdPoliza;
								...
								for (var i = 0; i < eOpts.length; i++) {
									miArray[i] = eOpts[i].data.IdPoliza;
