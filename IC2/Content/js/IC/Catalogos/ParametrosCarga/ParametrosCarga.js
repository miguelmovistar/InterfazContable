                ...
                columns: [
...

                    {
                        ...
                        items:
                        {
                            ...
                            {
                                keyup: function () {
                                    store_BuscarParametros.clearFilter();
                                    var cadena = this.value;
                                    if (this.value && cadena.length > 0) {
                                        store_BuscarParametros.load({ params: { start: 0, limit: 100000 } });
                                        store_BuscarParametros.filter({
