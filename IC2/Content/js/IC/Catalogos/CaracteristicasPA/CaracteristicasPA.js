                    ...
                    listeners:
                    {
                        selectionchange: function (selected, eOpts) {
                            if (eOpts.length == 1) {
                                ...
                                trafico_Id = eOpts[0].data.Trafico_Id;
                    ...
                    items: [
                        {
                            ...
                            handler: function () {
                                ...
                                var nTrafico = Ext.getCmp('idcmbTrafico').valueModels[0].data.Id_TraficoTR;
                                ...
                                if (form.wasValid) {
                                    form.submit({
                                        ...
                                        params:
                                        {
                                            ...
                                            idtrafico: Ext.getCmp('idcmbTrafico').value,
                                            trafico: nTrafico,
                    ...
                    items:
                        [
                            //CuentaResultados
                            {
                                ...
                                listeners:
                                {
                                    change: function (field, newValue, oldValue, eOpts) {
                                        ...
                                        var nValTrafico = Ext.getCmp('cmbCuentaRes').valueModels[0].data.Trafico_Id;
                                        Ext.getCmp('idcmbTrafico').setValue(nValTrafico);
                                    }
                                }
                            },
                            //sentido
                            ...
                            ////Trafico
                            {
                                ...
                                tpl: Ext.create('Ext.XTemplate',
                                    '<tpl for=".">',
                                    '<div class="x-boundlist-item">{Id} - {Id_TraficoTR}</div>',
                                    '</tpl>'
                                ),
                                displayTpl: Ext.create('Ext.XTemplate',
                                    '<tpl for=".">',
                    ...
                    items: [
                        {
                            ...
                            handler: function () {
                                ...
                                store_Modificar.getProxy().extraParams.idtrafico = Ext.getCmp('idcmbTrafico').value;
                                store_Modificar.getProxy().extraParams.trafico = nTrafico;
