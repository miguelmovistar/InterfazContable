                            ...
                            },
                            {
                                ...
                                listeners:
                                {
                                    change: function (field, newValue, oldValue, eOpts) {
                                        ...
                                        else if (Ext.getCmp('txtEntSuperior').value != null && Ext.getCmp('txtEntSuperior').value != "" && Ext.getCmp('txtSalSuperior').value != null && Ext.getCmp('txtSalSuperior').value != "") {
