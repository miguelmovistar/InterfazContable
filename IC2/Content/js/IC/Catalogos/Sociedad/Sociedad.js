                ...
                columns: [
                    { xtype: 'gridcolumn', hidden: true, dataIndex: 'Id' },
                    {
                        ...
                        items:
                        {
                            ...
                            {
                                keyup: function () {
                                    store_BuscarSociedad.clearFilter();
                                    var cadena = this.value;
                                    if (this.value && cadena.length > 0) {
                                        store_BuscarSociedad.load({ params: { start: 0, limit: 100000 } });
                                        store_BuscarSociedad.filter({
                                            property: 'Id_Sociedad',
                                            value: this.value,
                                            anyMatch: true,
                                            caseSensitive: false
                                        });
