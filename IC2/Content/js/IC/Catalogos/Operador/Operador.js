                ...
                columns: [
                    {
                        ...
                        items:
                        {
                            ...
                            {
                                keyup: function () {
                                    store_BuscarOperador.clearFilter();
                                    var cadena = this.value;
                                    if (this.value && cadena.length > 0) {
                                        store_BuscarOperador.load({ params: { start: 0, limit: 100000 } });
                                        store_BuscarOperador.filter({
                    ...
                    {
                        xtype: "gridcolumn", sortable: true, dataIndex: 'NombreAcreedor', flex: 1, locked: true, text: 'Acreedor', locked: false,
                        renderer: function (v, cellValues, rec) {
                            return rec.get('NombreAcreedor');
                        },
                        editor: {
                            xtype: 'textfield'
                        },
                    ...
                    {
                        xtype: "gridcolumn", sortable: true, dataIndex: 'NombreDeudor', flex: 1, locked: true, text: 'Deudor', locked: false,
                        renderer: function (v, cellValues, rec) {
                            return rec.get('NombreDeudor');
                        },
                        editor: {
                            xtype: 'textfield'
                        },
