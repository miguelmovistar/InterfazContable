...
Ext.onReady(function () {
    ...
    var ptb_DocumentosIngreso = new Ext.PagingToolbar({
        id: 'ptb_DocumentosIngreso',
                                ...
                                columns: [
                                    {
                                        ...
                                        items:
                                        {
                                            ...
                                            {
                                                keyup: function () {
                                                    store_BuscarDocumentosIngreso.clearFilter();
                                                    var cadena = this.value;
                                                    if (this.value && cadena.length > 1) {
                                                        store_BuscarDocumentosIngreso.load({ params: { start: 0, limit: 100000 } });
                                                        store_BuscarDocumentosIngreso.filter({
                                                            property: 'ano',
                                                            value: this.value,
                                                            anyMatch: true,
                                                            caseSensitive: false
