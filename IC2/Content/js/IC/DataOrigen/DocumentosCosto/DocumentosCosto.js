...
Ext.onReady(function () {
    ...
    var ptb_DocumentosCosto = new Ext.PagingToolbar({
        id: 'ptb_DocumentosCosto',
                                ...
                                columns: [
                                    {
                                        ...
                                        items:
                                        {
                                            ...
                                            {
                                                keyup: function () {
                                                    store_BuscarDocumentosCosto.clearFilter();
                                                    var cadena = this.value;
                                                    if (this.value && cadena.length > 1) {
                                                        store_BuscarDocumentosCosto.load({ params: { start: 0, limit: 100000 } });
                                                        store_BuscarDocumentosCosto.filter({
                                                            property: 'ano',
                                                            value: this.value,
                                                            anyMatch: true,
                                                            caseSensitive: false
