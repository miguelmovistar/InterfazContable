...
Ext.onReady(function () {
    ...
    var ptb_AjustesObjecion = new Ext.PagingToolbar({
        id: 'ptb_AjustesObjecion',
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        items:
                        {
                            ...
                            {
                                keyup: function () {
                                    store_BuscarAjustesObjecion.clearFilter();
                                    var cadena = this.value;
                                    if (this.value && cadena.length > 1) {
                                        store_BuscarAjustesObjecion.load({ params: { start: 0, limit: 100000 } });
                                        store_BuscarAjustesObjecion.filter({
                                            property: 'sentido',
                                            value: this.value,
                                            anyMatch: true,
                                            caseSensitive: false
