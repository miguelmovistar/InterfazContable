...
namespace IC2.Controllers
{
    public class DataCostoController : Controller
    {
        ...
        public JsonResult LlenaGrid(DateTime periodo, string trafico, string cmbacreedor, int start, int limit)
        {
            ...
            try {
                var costos = from costo in db.DataCostoLDI
                             join Movimiento in db.Movimiento
                                on costo.id_movimiento equals Movimiento.Id into gjmv
                             ...
                             join grupo in db.Grupo
                                on costo.id_grupo equals grupo.Id into gjgr
