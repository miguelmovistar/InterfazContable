                ...
                foreach (string linea in Lineas) {
                    ...
                    if (ValidaLinea(arreglo)) {
                        lista.Add(new NotaCredito
                        {
                            ...
                            mes_consumo = Convert.ToDateTime(arreglo[9])
                        });
                ...
                try {
                    ...
                    foreach (var elemento in notacredito) {
                        lista.Add(new
                        {
                            ...
                            mes_consumo = elemento.mes_consumo.ToString("yyyy MMMM", new CultureInfo("es-ES")).ToUpper(),
                        });
                    }
                    total = lista.Count();
            ...
            try {
                ...
                foreach (var elemento in lista) {
                    ...
                    if (listaID.Exists(x => x.texto == arrOperadores[contador])) {
                        elemento.id_operador = listaID.Where(x => x.texto == arrOperadores[contador]).FirstOrDefault().clave;
                        elemento.activo = 1;
                        elemento.periodo_carga = fecha_contable;
                        elemento.id_lineaNegocio = lineaNegocio;
                    } else {
                    ...
                    if (listaID.Exists(x => x.texto == arrGrupo[contador])) {
                        elemento.id_grupo = listaID.Where(x => x.texto == arrGrupo[contador]).FirstOrDefault().clave;
                        elemento.activo = 1;
                        elemento.periodo_carga = fecha_contable;
                        elemento.id_lineaNegocio = lineaNegocio;
                    } else {
