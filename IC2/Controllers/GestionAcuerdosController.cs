    ...
    public class GestionAcuerdosController : Controller
    {
        ...
        public JsonResult Recalcular(DateTime periodo)
        {
            ...
            try {
                ...
                // CIERRES
                db.sp_provisionIngreso(periodo, "CIERRE", "GACierreIngresosLDI");
                ...
                using (var sw = new StreamWriter(fullpath)) {
                    ...
                    foreach (var elemento in datos) {
                        ...
                        sw.WriteLine(string.Format("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\t{8}\t{9}",
                            ...
                            0,
                            elemento.Moneda,
                            Convert.ToDouble( elemento.tarifaPoliza), //revisar
                            Convert.ToDouble(elemento.minutosPoliza), //revisar
                            elemento.llamadas,
                            Convert.ToDouble(elemento.USDPoliza)
                            ));
                    }
