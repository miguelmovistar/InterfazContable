...
{
    public class ReportesDevengoController : Controller
    {
        ...
        public static void ColocarDatosCuenta(ref ExcelWorksheet worksheet, DataRow pDevengoCosto, int plFila, Boolean tipo)
        {
            ...
            worksheet.Cells[("G" + plFila)].Value = pDevengoCosto["Operador"];
            ...
            worksheet.Cells[("M" + plFila)].Value = (!String.IsNullOrEmpty(pDevengoCosto["CancelProvision"].ToString())) ? Convert.ToDecimal(pDevengoCosto["CancelProvision"]) : (0);
            worksheet.Cells[("M" + plFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("N" + plFila)].Value = (!String.IsNullOrEmpty(pDevengoCosto["CancelProvNCR"].ToString())) ? Convert.ToDecimal(pDevengoCosto["CancelProvNCR"]) : (0);
            worksheet.Cells[("N" + plFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("O" + plFila)].Value = (!String.IsNullOrEmpty(pDevengoCosto["Facturacion"].ToString())) ? Convert.ToDecimal(pDevengoCosto["Facturacion"]) : (0);
            worksheet.Cells[("O" + plFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("P" + plFila)].Value = (!String.IsNullOrEmpty(pDevengoCosto["NCREmitidas"].ToString())) ? Convert.ToDecimal(pDevengoCosto["NCREmitidas"]) : (0);
            worksheet.Cells[("P" + plFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("Q" + plFila)].Value = (!String.IsNullOrEmpty(pDevengoCosto["Provision"].ToString())) ? Convert.ToDecimal(pDevengoCosto["Provision"]) : (0);
            worksheet.Cells[("Q" + plFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("R" + plFila)].Value = (!String.IsNullOrEmpty(pDevengoCosto["ProvisionNCR"].ToString())) ? Convert.ToDecimal(pDevengoCosto["ProvisionNCR"]) : (0);
            worksheet.Cells[("R" + plFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("S" + plFila)].Value = (!String.IsNullOrEmpty(pDevengoCosto["Exceso"].ToString())) ? Convert.ToDecimal(pDevengoCosto["Exceso"]) : (0);
            worksheet.Cells[("S" + plFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("T" + plFila)].Value = (!String.IsNullOrEmpty(pDevengoCosto["TotalDevengo"].ToString())) ? Convert.ToDecimal(pDevengoCosto["TotalDevengo"]) : (0);
            worksheet.Cells[("T" + plFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";

            if (!tipo) {
                worksheet.Cells[("U" + plFila)].Value = (!String.IsNullOrEmpty(pDevengoCosto["Fluctuacion"].ToString())) ? Convert.ToDecimal(pDevengoCosto["Fluctuacion"]) : (0);
                worksheet.Cells[("U" + plFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
                worksheet.Cells[("V" + plFila)].Value = (!String.IsNullOrEmpty(pDevengoCosto["TotalDevengoFluctuacion"].ToString())) ? Convert.ToDecimal(pDevengoCosto["TotalDevengoFluctuacion"]) : (0);
