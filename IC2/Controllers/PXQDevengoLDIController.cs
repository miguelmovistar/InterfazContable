...
{
    public class PXQDevengoLDIController : Controller
    {
        ...
        public static void HojaDevengoDocumento(ref ExcelWorksheet worksheet, DateTime periodo, int tabla, ICPruebaEntities db)
        {
            ...
            worksheet.Cells["A7:T" + lFila].Style.HorizontalAlignment = ExcelHorizontalAlignment.Right;
        }
        ...
        public static void ColocarEstilos(ExcelWorksheet worksheet, int pFila, long pCuentaPrimaria, Boolean tipo)
        {
            ...
            string rango = "";
            if (tipo)
                rango = ("A" + pFila + ":R" + pFila);
            else
                rango = ("A" + pFila + ":T" + pFila);
        ...
        public static void ColocarDatosCuenta(ref ExcelWorksheet worksheet, DataRow pDevengoIngreso, int pFila, Boolean tipo)
        {
            ...
            worksheet.Cells[("E" + pFila)].Value = pDevengoIngreso["Operador"];
            ...
            worksheet.Cells[("K" + pFila)].Value = (!String.IsNullOrEmpty(pDevengoIngreso["CancelProvision"].ToString())) ? (Convert.ToDecimal(pDevengoIngreso["CancelProvision"])) : (0);
            worksheet.Cells[("K" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("L" + pFila)].Value = (!String.IsNullOrEmpty(pDevengoIngreso["CancelProvNCR"].ToString())) ? (Convert.ToDecimal(pDevengoIngreso["CancelProvNCR"])) : (0);
            worksheet.Cells[("L" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("M" + pFila)].Value = (!String.IsNullOrEmpty(pDevengoIngreso["Facturacion"].ToString())) ? (Convert.ToDecimal(pDevengoIngreso["Facturacion"])) : (0);
            worksheet.Cells[("M" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("N" + pFila)].Value = (!String.IsNullOrEmpty(pDevengoIngreso["NCREmitidas"].ToString())) ? (Convert.ToDecimal(pDevengoIngreso["NCREmitidas"])) : (0);
            worksheet.Cells[("N" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("O" + pFila)].Value = (!String.IsNullOrEmpty(pDevengoIngreso["Provision"].ToString())) ? (Convert.ToDecimal(pDevengoIngreso["Provision"])) : (0);
            worksheet.Cells[("O" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("P" + pFila)].Value = (!String.IsNullOrEmpty(pDevengoIngreso["ProvisionNCR"].ToString())) ? (Convert.ToDecimal(pDevengoIngreso["ProvisionNCR"])) : (0);
            worksheet.Cells[("P" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("Q" + pFila)].Value = (!String.IsNullOrEmpty(pDevengoIngreso["Exceso"].ToString())) ? (Convert.ToDecimal(pDevengoIngreso["Exceso"])) : (0);
            worksheet.Cells[("Q" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("R" + pFila)].Value = (!String.IsNullOrEmpty(pDevengoIngreso["TotalDevengo"].ToString())) ? (Convert.ToDecimal(pDevengoIngreso["TotalDevengo"])) : (0);
            worksheet.Cells[("R" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            if (!tipo) {
                worksheet.Cells[("S" + pFila)].Value = (!String.IsNullOrEmpty(pDevengoIngreso["Fluctuacion"].ToString())) ? (Convert.ToDecimal(pDevengoIngreso["Fluctuacion"])) : (0);
                worksheet.Cells[("S" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
                worksheet.Cells[("T" + pFila)].Value = (!String.IsNullOrEmpty(pDevengoIngreso["TotalDevengoFluctuacion"].ToString())) ? (Convert.ToDecimal(pDevengoIngreso["TotalDevengoFluctuacion"])) : (0);
        ...
        public static void ColocarSubtotales(ref ExcelWorksheet worksheet, int pFila, long pCuentaPrimaria, decimal[] listaSubtotales, Boolean tipo)
        {
            ...
            worksheet.Cells[("J" + pFila)].Value = "Subtotal: ";
            worksheet.Cells[("K" + pFila)].Value = listaSubtotales[0];
            worksheet.Cells[("K" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("L" + pFila)].Value = listaSubtotales[1];
            worksheet.Cells[("L" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("M" + pFila)].Value = listaSubtotales[2];
            worksheet.Cells[("M" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("N" + pFila)].Value = listaSubtotales[3];
            worksheet.Cells[("N" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("O" + pFila)].Value = listaSubtotales[4];
            worksheet.Cells[("O" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("P" + pFila)].Value = listaSubtotales[5];
            worksheet.Cells[("P" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("Q" + pFila)].Value = listaSubtotales[6];
            worksheet.Cells[("Q" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            worksheet.Cells[("R" + pFila)].Value = listaSubtotales[7];
            worksheet.Cells[("R" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            if (!tipo) {
                worksheet.Cells[("S" + pFila)].Value = listaSubtotales[8];
                worksheet.Cells[("S" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
                worksheet.Cells[("T" + pFila)].Value = listaSubtotales[9];
                worksheet.Cells[("T" + pFila)].Style.Numberformat.Format = "_-$* #,##0.00_-";
            }
        }
    }
