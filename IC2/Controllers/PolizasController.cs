...
namespace IC2.Controllers
{
    public class PolizasController : Controller
    {
        ...
        public JsonResult ObtenerCabeceraRegistro(string Id, string ClaseDocumento, string Poliza, string Nombre,string Estado)
        {
            ...
            try
            {
               ...
               // db.usp_InsertarLinea1();
                ...
                var CabeceraArchivo = from Linea1 in db.LineaArchivo1
                                      where Linea1.Id_Devengo == IdDevengo && Linea1.ClaseDocumento == ClaseDocumento
                                      select Linea1;
        ...
        public JsonResult llenaPeriodo(int start, int limit)
        {
            ...
            try
            {
                var datos = from periodos in db.Polizas where periodos.PolizaGenerada == true
