...
namespace IC2.Controllers
{
    public class CaracteristicasPAController : Controller
    {
        ...
        public JsonResult AgregarCaracteristicaPA(int idCuenta, string cuenta, string sentido, string codMaterial, string material, string subsegmentoPA, string segmentoPA, string producto, string canal, string bundle, int idtrafico, string trafico, string subtipoLinea, string licencia, string region, string ambito, int lineaNegocio)
        {
            object respuesta = null;
            try {
