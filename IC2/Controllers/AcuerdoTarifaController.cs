        ...
        public JsonResult llenaGrid(int lineaNegocio, int start, int limit)
        {
            ...
            try
            {
                ...
                var acuerdo = from elemento in db.AcuerdoTarifa
                              ...
                              on elemento.Id_TraficoEntrada equals trafico.Id
                              join traficoSal in db.Trafico
                              on elemento.Id_TraficoSalida equals traficoSal.Id
                              where
                              ...
                              select new
                              {
                                  ...
                                  operador.Nombre,
                                  elemento.EntInferior,
                                  elemento.EntSuperior,
                                  elemento.TarifaEnt,
                                  elemento.Ingreso,
                                  elemento.SalInferior,
                                  elemento.SalSuperior,
                                  elemento.TarifaSal,
                                  elemento.Costo,
                                  elemento.Ratio,
                                  elemento.FechaInicio,
                                  elemento.FechaFin,
                                  elemento.Id_TraficoEntrada,
                                  //trafico.Id_TraficoTR,
                                  elemento.Id_TraficoSalida
                              };
                ...
                foreach (var elemento in acuerdo)
                {
                    lista.Add(new
                    {
                        ...
                        DescripcionEntrada = db.Trafico.Where(x=>x.Id == elemento.Id_TraficoEntrada).SingleOrDefault().Descripcion,
                        DescripcionSalida = db.Trafico.Where(x=>x.Id == elemento.Id_TraficoSalida).SingleOrDefault().Descripcion
